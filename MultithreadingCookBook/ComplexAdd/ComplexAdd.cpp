// ComplexAdd.cpp : Defines the entry point for the console application.
//
...
{
    dReal = dReal1 + dReal2;  dImg = dImg1 + dImg2;
}
double Rand(double dMin, double dMax)
{
    double dVal = (double)rand() / RAND_MAX;  return dMin + dVal * (dMax - dMin);
}
int _tmain(int argc, TCHAR* argv[])
{
    ...
    cout << dReal << "+" << dImg << "i" << endl;    return 0;
}